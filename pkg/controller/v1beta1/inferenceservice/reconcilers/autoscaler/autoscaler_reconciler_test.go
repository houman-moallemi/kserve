...
func TestCreateAutoscaler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			as, err := createAutoscaler(nil, nil, meta, &v1beta1.ComponentExtensionSpec{}, constants.DeploymentTargetTypeDeployment, configMap)
...
func TestExternalAutoscalerWithNilComponentExt(t *testing.T) {
	...
	as, err := createAutoscaler(nil, nil, meta, nil, constants.DeploymentTargetTypeDeployment, nil)
	if err != nil {
